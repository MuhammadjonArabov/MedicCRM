    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_customer_count', models.IntegerField(default=0, verbose_name='Add customer count')),
                ...
                ('page_permissions', models.ManyToManyField(related_name='page', to='user.page', verbose_name='Page Permissions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sending_at', models.DateTimeField(blank=True, null=True, verbose_name='Sending at')),
                ('customers', models.ManyToManyField(related_name='sms_customers', to='common.customer', verbose_name='Customers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_visits', to='user.seller', verbose_name='User')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('action', models.CharField(choices=[('add_customer', "Xaridor qo'shish"), ('sale', 'Sotuv'), ('do_activation', 'Foallashtirgan')], default='add_customer', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='comments_files/', verbose_name='File')),
                ...
                ('seller', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='seller_comments', to='user.seller', verbose_name='Seller')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_comments', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'abstract': False,
            },
